...
import BasicStatistics from '../components/statisticsdetails/BasicStatistics'
import PastWeekStatistics from '../components/statisticsdetails/PastWeekStatistics'
import CurrentMonthStatistics from '../components/statisticsdetails/CurrentMonthStatistics'
    ...
    return (
        <div className='h-screen w-screen flex flex-col items-center bg-webBgColor text-primaryTextColor'>
            ...
            <div className='w-full max-w-4xl h-screen bg-subBgColor no-scrollbar overflow-y-auto flex flex-col gap-3 py-3 pb-8 my-[56px] px-3 lg:px-5'>
                <div className='font-bold text-2xl w-full px-3 pb-2 border-b border-primaryColor'>{habit.habit_name}</div>

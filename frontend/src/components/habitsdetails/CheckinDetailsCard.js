    ...
    return (
        <div className='flex flex-col items-start justify-center bg-appPrimaryLight rounded-3xl px-5 py-3 gap-2'>
            ...
            <div className='flex flex-row justify-start items-center gap-2 w-full'>
                ...
                <div className='font-bold text-appPrimaryColor text-lg flex-1 center-of-div'>{weeklyCount}</div>
            </div>
            <div className='flex flex-row justify-start items-center gap-2 w-full'>
                <FontAwesomeIcon className='text-appPrimaryColor text-lg' icon={faCalendarDays} />
                <div className='flex-1'>This past month: </div>
                <div className='font-bold text-appPrimaryColor text-lg flex-1 center-of-div'>{monthlyCount}</div>
            </div>
        </div>
    )
}

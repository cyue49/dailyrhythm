    ...
    return (
        <div className='center-of-div flex-col flex-nowrap w-full gap-1'>
            <div className='flex flex-row flex-nowrap w-full justify-center items-center gap-3'>
                <Popover>
                    <PopoverButton><FontAwesomeIcon className='text-primaryColor cursor-pointer' icon={faPenToSquare} /></PopoverButton>
                    <PopoverPanel
                        transition
                        anchor="right"
                ...
                <div className='text-primaryColor font-bold'>{categoryName}</div>

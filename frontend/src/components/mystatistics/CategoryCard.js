...
const CategoryCard = ({ category }) => {
    ...
    // const navigateTo = () => { navigate('/mystatistics/details', { state: { category: category, totalCheckins: totalCount } }) }
    return (
        <div className='w-full flex flex-row flex-nowrap items-center justify-between px-3 py-2 gap-4 rounded-full bg-mainCardColor'>

...
const ArchivedHabitCard = ({ habit, archivedHabits, setArchivedHabits, deselectAll, selectAll }) => {
    ...
    return (
        <div className='w-full center-of-div flex-row gap-2 primaryTextColor'>
            <Checkbox checked={checked} onChange={handleCheck} className="rounded-md border border-primaryColor size-5 overflow-hidden">
                {checked ?
            ...
            <div className='flex-1 flex flex-row flex-nowrap items-center justify-between px-3 py-2 gap-4 rounded-full bg-mainCardColor'>
